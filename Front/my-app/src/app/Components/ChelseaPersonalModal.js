...
export default function ChelseaPersonalModal() {
    ...
    const [MyPersonalCart, setMyPersonalCart] = useState([])
    ...
    return (
        <div>
            <Button onClick={handleClickOpen}>
                <img style={{ width: "250px", height: "250px" }} src={chelseaShirtFront}></img>
            </Button>
            <BootstrapDialog
                onClose={handleClose}
            ...
            >
                <BootstrapDialogTitle id="customized-dialog-title" onClose={handleClose}>
                    <p style={{ fontSize: "20px", textAlign: 'center' }}>Chelsea Shirt 2022/2023</p>
                    <p style={{ fontSize: "35px", textAlign: 'center' }}>140₪</p>
                        ...
                        <div>
                            <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-around" }}>
                                ...
                                <div onMouseOver={() => setOver(true)}
                                    ...
                                    <img src={over ? chelseaShirtBack : chelseaShirtFront}
                                        alt="arrow"
                                        width="250"
                                        height="250" ></img>
                                </div>
                            ...
                            <div>
                                <div style={{ display: "flex", flexDirection: "row", justifyContent: "center" }}>
                                    <p style={{ paddingTop: "0px" }}>Quantity:{Quantitycount}  |   Price:140</p>
                                </div>
                                <p style={{ textAlign: "center" }}>Total: {Quantitycount * 140}₪</p>
                            </div>
                        </div>
                    </div>
